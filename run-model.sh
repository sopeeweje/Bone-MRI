pipenv run python run.py --description $1 --model v2 --form t1c-features --label outcome --hyperparameters hyperparameters.json #--split 27863f52-d15d-4cc1-be66-155872f20d6b #b888e896-e151-4224-8b4e-12d36f6307c8
