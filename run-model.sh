pipenv run python run.py --description $1 --model v2 --form t1c --label outcome --hyperparameters hyperparameters.json --split 27863f52-d15d-4cc1-be66-155872f20d6b 
