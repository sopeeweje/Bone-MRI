python3 xrun.py --description $1 --model v2 --form t1c --label outcome_pos --hyperparameters xhyperparameters.json --split 84a64c17-fe3e-440c-aaaf-e1bd5b02576f
...
#python3 xrun.py --description $1 --model v2 --form t2 --label outcome_pos --hyperparameters xhyperparameters.json --split 84a64c17-fe3e-440c-aaaf-e1bd5b02576f

#python3 xrun.py --description $1 --model v2 --form t1 --label outcome_pos --hyperparameters xhyperparameters.json --split 84a64c17-fe3e-440c-aaaf-e1bd5b02576f
